...
function ProductsPage() {
    ...
    filterLoading,filterError,productError,searchError,searchLoading} = useSelector(state=>state.product)
    ...
    const {productList,filter,searchProduct,productSearchClear,setDropViewClose,
           ...
           setProductSearchAlert} = bindActionCreators(productActions,dispatch)
